...
printf "                                                   \e[1;92m.-\"\"\"\"-. \e[0m\n"
printf "                                                  \e[1;92m/        \ \e[0m\n"
printf "\e[1;77m _____ ____  ____  ____  _     
printf "\e[1;77m /  __//  __\/_   \/  _ \/ \__/|  
printf "\e[1;77m |  \  |  \/| /   /| / \|| |\/|| 
printf "\e[1;77m |  /_ |    //   /_| |-||| |  ||
printf "\e[1;77m \____\\_/\_\\____/\_/ \|\_/  \|
...
check1=$(curl -s -i "https://www.tiktok.com/@$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'Not Found' ; echo $?)
